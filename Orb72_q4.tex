...
Rank of lines: ( 0, 84, 80, 59 )\\
Rank of points on Klein quadric: ( 0, 10, 258, 318 )\\
...
$P_{7} = ( 3, 1, 0, 0 ) = \ell_{0} \cap \ell_{3} $\\
...
2 : $P_{23}=( 1, 0, 0, 1 )$ lies on line $\ell_{1}$\\
3 : $P_{27}=( 1, 1, 0, 1 )$ lies on line $\ell_{1}$\\
4 : $P_{31}=( 1, 2, 0, 1 )$ lies on line $\ell_{1}$\\
5 : $P_{35}=( 1, 3, 0, 1 )$ lies on line $\ell_{1}$\\
6 : $P_{43}=( 2, 1, 1, 1 )$ lies on line $\ell_{2}$\\
7 : $P_{44}=( 3, 1, 1, 1 )$ lies on line $\ell_{3}$\\
8 : $P_{46}=( 1, 2, 1, 1 )$ lies on line $\ell_{3}$\\
9 : $P_{48}=( 3, 2, 1, 1 )$ lies on line $\ell_{2}$\\
10 : $P_{50}=( 1, 3, 1, 1 )$ lies on line $\ell_{2}$\\
11 : $P_{51}=( 2, 3, 1, 1 )$ lies on line $\ell_{3}$\\
\end{multicols}
The single points on the surface are:\\
