...
S_{2} &= P_{26}=\bP(0, 1, 0, 1) = \bP(0, 1, 0, 1)\\
S_{3} &= P_{30}=\bP(0, \omega , 0, 1) = \bP(0, 2, 0, 1)\\
S_{4} &= P_{34}=\bP(0, \omega^{2}, 0, 1) = \bP(0, 3, 0, 1)\\
\end{align*}
...
Rank of lines: ( 20, 340, 125, 293, 209 )\\
Rank of points on Klein quadric: ( 25, 9, 57, 59, 58 )\\
...
4 : $P_{17}=( 2, 2, 1, 0 )$ lies on line $\ell_{3}$\\
5 : $P_{22}=( 3, 3, 1, 0 )$ lies on line $\ell_{4}$\\
...
10 : $P_{30}=( 0, 2, 0, 1 )$ lies on line $\ell_{1}$\\
11 : $P_{34}=( 0, 3, 0, 1 )$ lies on line $\ell_{1}$\\
12 : $P_{47}=( 2, 2, 1, 1 )$ lies on line $\ell_{3}$\\
13 : $P_{52}=( 3, 3, 1, 1 )$ lies on line $\ell_{4}$\\
14 : $P_{58}=( 1, 1, 2, 1 )$ lies on line $\ell_{4}$\\
15 : $P_{63}=( 2, 2, 2, 1 )$ lies on line $\ell_{2}$\\
16 : $P_{68}=( 3, 3, 2, 1 )$ lies on line $\ell_{3}$\\
17 : $P_{74}=( 1, 1, 3, 1 )$ lies on line $\ell_{3}$\\
18 : $P_{79}=( 2, 2, 3, 1 )$ lies on line $\ell_{4}$\\
19 : $P_{84}=( 3, 3, 3, 1 )$ lies on line $\ell_{2}$\\
\end{multicols}
The single points on the surface are:\\
