...
Rank of lines: ( 0, 5, 110, 133, 153 )\\
Rank of points on Klein quadric: ( 0, 33, 199, 346, 296 )\\
...
$P_{42} = ( 0, 1, 1, 1 ) = \ell_{1} \cap \ell_{2} $\\
$P_{51} = ( 2, 3, 1, 1 ) = \ell_{2} \cap \ell_{3} $\\
$P_{48} = ( 3, 2, 1, 1 ) = \ell_{2} \cap \ell_{4} $\\
$P_{12} = ( 1, 1, 1, 0 ) = \ell_{3} \cap \ell_{4} $\\
\end{multicols}
\subsubsection*{Single Points}
The surface has 13 single points:\\
...
4 : $P_{33}=( 3, 2, 0, 1 )$ lies on line $\ell_{3}$\\
5 : $P_{36}=( 2, 3, 0, 1 )$ lies on line $\ell_{4}$\\
6 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{2}$\\
7 : $P_{43}=( 2, 1, 1, 1 )$ lies on line $\ell_{1}$\\
8 : $P_{44}=( 3, 1, 1, 1 )$ lies on line $\ell_{1}$\\
9 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{3}$\\
10 : $P_{57}=( 0, 1, 2, 1 )$ lies on line $\ell_{4}$\\
11 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{4}$\\
12 : $P_{73}=( 0, 1, 3, 1 )$ lies on line $\ell_{3}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{5} & P_{42} & P_{51} & P_{48}\\
\hline
\end{array}
$$
Line 3 intersects 
