...
\begin{align*}
S_{0} &= P_{54}=\bP(1, 0, \omega , 1) = \bP(1, 0, 2, 1)\\
S_{1} &= P_{70}=\bP(1, 0, \omega^{2}, 1) = \bP(1, 0, 3, 1)\\
\end{align*}
...
Rank of lines: ( 356, 100, 38, 122 )\\
Rank of points on Klein quadric: ( 1, 6, 198, 202 )\\
...
3 : $P_{12}=( 1, 1, 1, 0 )$ lies on line $\ell_{3}$\\
4 : $P_{23}=( 1, 0, 0, 1 )$ lies on line $\ell_{1}$\\
5 : $P_{27}=( 1, 1, 0, 1 )$ lies on line $\ell_{3}$\\
6 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{1}$\\
7 : $P_{47}=( 2, 2, 1, 1 )$ lies on line $\ell_{2}$\\
8 : $P_{52}=( 3, 3, 1, 1 )$ lies on line $\ell_{2}$\\
9 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{0}$\\
10 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{1}$\\
11 : $P_{68}=( 3, 3, 2, 1 )$ lies on line $\ell_{3}$\\
12 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{0}$\\
13 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{1}$\\
14 : $P_{79}=( 2, 2, 3, 1 )$ lies on line $\ell_{3}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{2} & P_{38} & P_{38}\\
\hline
\end{array}
$$
Line 1 intersects 
