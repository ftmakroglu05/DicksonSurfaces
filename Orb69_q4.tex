...
S_{2} &= P_{27}=\bP(1, 1, 0, 1) = \bP(1, 1, 0, 1)\\
\end{align*}
...
Rank of lines: ( 0, 16, 37, 84, 121, 100, 26, 89 )\\
Rank of points on Klein quadric: ( 0, 2, 108, 10, 112, 6, 180, 74 )\\
\subsubsection*{Eckardt Points}
The surface has 2 Eckardt points:\\
$0 : P_{23}=\bP(1, 0, 0, 1) = \bP(1, 0, 0, 1),\; T= -1$\\
$1 : P_{27}=\bP(1, 1, 0, 1) = \bP(1, 1, 0, 1).\; T= -1$\\
...
$P_{8} = ( 1, 0, 1, 0 ) = \ell_{1} \cap \ell_{6} $\\
$P_{12} = ( 1, 1, 1, 0 ) = \ell_{2} \cap \ell_{7} $\\
...
3 : $P_{9}=( 2, 0, 1, 0 )$ lies on line $\ell_{1}$\\
4 : $P_{10}=( 3, 0, 1, 0 )$ lies on line $\ell_{1}$\\
5 : $P_{17}=( 2, 2, 1, 0 )$ lies on line $\ell_{2}$\\
6 : $P_{22}=( 3, 3, 1, 0 )$ lies on line $\ell_{2}$\\
7 : $P_{31}=( 1, 2, 0, 1 )$ lies on line $\ell_{3}$\\
8 : $P_{35}=( 1, 3, 0, 1 )$ lies on line $\ell_{3}$\\
9 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{5}$\\
10 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{5}$\\
11 : $P_{58}=( 1, 1, 2, 1 )$ lies on line $\ell_{4}$\\
12 : $P_{60}=( 3, 1, 2, 1 )$ lies on line $\ell_{6}$\\
13 : $P_{64}=( 3, 2, 2, 1 )$ lies on line $\ell_{7}$\\
14 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{5}$\\
15 : $P_{74}=( 1, 1, 3, 1 )$ lies on line $\ell_{4}$\\
16 : $P_{75}=( 2, 1, 3, 1 )$ lies on line $\ell_{6}$\\
17 : $P_{83}=( 2, 3, 3, 1 )$ lies on line $\ell_{7}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{0} & P_{2} & P_{2} & P_{2} & P_{8}\\
\hline
\end{array}
$$
Line 2 intersects 
...
\hline
\mbox{in point}  & P_{5} & P_{2} & P_{2} & P_{2} & P_{12}\\
\hline
\end{array}
$$
Line 3 intersects 
...
\hline
\mbox{in point}  & P_{1} & P_{27} & P_{23} & P_{27} & P_{23}\\
\hline
\end{array}
$$
Line 4 intersects 
...
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{27} & P_{2} & P_{27}\\
\hline
\end{array}
$$
Line 5 intersects 
...
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{23} & P_{2} & P_{23}\\
\hline
\end{array}
$$
Line 6 intersects 
...
\hline
\mbox{in point}  & P_{8} & P_{27} & P_{27} & P_{42}\\
\hline
\end{array}
$$
Line 7 intersects 
...
\hline
\mbox{in point}  & P_{12} & P_{23} & P_{23} & P_{42}\\
\hline
\end{array}
$$
