...
Rank of lines: ( 247, 310, 89 )\\
Rank of points on Klein quadric: ( 121, 127, 74 )\\
...
$P_{64} = ( 3, 2, 2, 1 ) = \ell_{0} \cap \ell_{2} $\\
$P_{83} = ( 2, 3, 3, 1 ) = \ell_{1} \cap \ell_{2} $\\
\end{multicols}
...
\begin{multicols}{2}
\noindent
0 : $P_{12}=( 1, 1, 1, 0 )$ lies on line $\ell_{2}$\\
1 : $P_{23}=( 1, 0, 0, 1 )$ lies on line $\ell_{2}$\\
2 : $P_{33}=( 3, 2, 0, 1 )$ lies on line $\ell_{0}$\\
3 : $P_{36}=( 2, 3, 0, 1 )$ lies on line $\ell_{1}$\\
4 : $P_{42}=( 0, 1, 1, 1 )$ lies on line $\ell_{2}$\\
5 : $P_{48}=( 3, 2, 1, 1 )$ lies on line $\ell_{0}$\\
6 : $P_{51}=( 2, 3, 1, 1 )$ lies on line $\ell_{1}$\\
7 : $P_{67}=( 2, 3, 2, 1 )$ lies on line $\ell_{1}$\\
8 : $P_{80}=( 3, 2, 3, 1 )$ lies on line $\ell_{0}$\\
\end{multicols}
The single points on the surface are:\\
