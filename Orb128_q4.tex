...
Rank of lines: ( 337, 356 )\\
Rank of points on Klein quadric: ( 129, 1 )\\
...
4 : $P_{45}=( 0, 2, 1, 1 )$ lies on line $\ell_{0}$\\
5 : $P_{49}=( 0, 3, 1, 1 )$ lies on line $\ell_{0}$\\
