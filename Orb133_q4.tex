...
Rank of lines: ( 356, 100, 290, 206 )\\
Rank of points on Klein quadric: ( 1, 6, 204, 203 )\\
...
1 : $P_{17}=( 2, 2, 1, 0 )$ lies on line $\ell_{2}$\\
2 : $P_{22}=( 3, 3, 1, 0 )$ lies on line $\ell_{3}$\\
3 : $P_{23}=( 1, 0, 0, 1 )$ lies on line $\ell_{1}$\\
4 : $P_{32}=( 2, 2, 0, 1 )$ lies on line $\ell_{2}$\\
5 : $P_{37}=( 3, 3, 0, 1 )$ lies on line $\ell_{3}$\\
6 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{1}$\\
7 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{0}$\\
8 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{1}$\\
9 : $P_{58}=( 1, 1, 2, 1 )$ lies on line $\ell_{2}$\\
10 : $P_{63}=( 2, 2, 2, 1 )$ lies on line $\ell_{3}$\\
11 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{0}$\\
12 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{1}$\\
13 : $P_{74}=( 1, 1, 3, 1 )$ lies on line $\ell_{3}$\\
14 : $P_{84}=( 3, 3, 3, 1 )$ lies on line $\ell_{2}$\\
\end{multicols}
The single points on the surface are:\\
