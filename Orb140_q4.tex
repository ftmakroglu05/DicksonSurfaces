...
\begin{align*}
S_{0} &= P_{68}=\bP(\omega^{2}, \omega^{2}, \omega , 1) = \bP(3, 3, 2, 1)\\
S_{1} &= P_{79}=\bP(\omega , \omega , \omega^{2}, 1) = \bP(2, 2, 3, 1)\\
\end{align*}
...
Rank of lines: ( 356, 122, 99, 94 )\\
Rank of points on Klein quadric: ( 1, 202, 83, 92 )\\
...
$P_{68} = ( 3, 3, 2, 1 ) = \ell_{1} \cap \ell_{2} $\\
$P_{79} = ( 2, 2, 3, 1 ) = \ell_{1} \cap \ell_{3} $\\
$P_{23} = ( 1, 0, 0, 1 ) = \ell_{2} \cap \ell_{3} $\\
\end{multicols}
...
2 : $P_{12}=( 1, 1, 1, 0 )$ lies on line $\ell_{1}$\\
3 : $P_{16}=( 1, 2, 1, 0 )$ lies on line $\ell_{2}$\\
4 : $P_{20}=( 1, 3, 1, 0 )$ lies on line $\ell_{3}$\\
5 : $P_{27}=( 1, 1, 0, 1 )$ lies on line $\ell_{1}$\\
6 : $P_{45}=( 0, 2, 1, 1 )$ lies on line $\ell_{2}$\\
7 : $P_{49}=( 0, 3, 1, 1 )$ lies on line $\ell_{3}$\\
8 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{0}$\\
9 : $P_{60}=( 3, 1, 2, 1 )$ lies on line $\ell_{3}$\\
10 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{0}$\\
11 : $P_{75}=( 2, 1, 3, 1 )$ lies on line $\ell_{2}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{38} & P_{68} & P_{79}\\
\hline
\end{array}
$$
Line 2 intersects 
