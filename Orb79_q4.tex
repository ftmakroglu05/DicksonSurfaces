...
\begin{align*}
S_{0} &= P_{31}=\bP(1, \omega , 0, 1) = \bP(1, 2, 0, 1)\\
S_{1} &= P_{35}=\bP(1, \omega^{2}, 0, 1) = \bP(1, 3, 0, 1)\\
\end{align*}
...
Rank of lines: ( 0, 17, 84, 38 )\\
Rank of points on Klein quadric: ( 0, 32, 10, 198 )\\
...
$P_{38} = ( 0, 0, 1, 1 ) = \ell_{1} \cap \ell_{3} $\\
\end{multicols}
...
5 : $P_{31}=( 1, 2, 0, 1 )$ lies on line $\ell_{2}$\\
6 : $P_{35}=( 1, 3, 0, 1 )$ lies on line $\ell_{2}$\\
7 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{1}$\\
8 : $P_{40}=( 2, 0, 1, 1 )$ lies on line $\ell_{1}$\\
9 : $P_{41}=( 3, 0, 1, 1 )$ lies on line $\ell_{1}$\\
10 : $P_{47}=( 2, 2, 1, 1 )$ lies on line $\ell_{3}$\\
11 : $P_{52}=( 3, 3, 1, 1 )$ lies on line $\ell_{3}$\\
\end{multicols}
The single points on the surface are:\\
