...
Rank of lines: ( 0, 16, 37, 340, 84, 356, 121, 100, 25, 109 )\\
Rank of points on Klein quadric: ( 0, 2, 108, 9, 10, 1, 112, 6, 177, 189 )\\
...
$P_{8} = ( 1, 0, 1, 0 ) = \ell_{1} \cap \ell_{8} $\\
$P_{12} = ( 1, 1, 1, 0 ) = \ell_{2} \cap \ell_{9} $\\
$P_{3} = ( 0, 0, 0, 1 ) = \ell_{3} \cap \ell_{5} $\\
$P_{27} = ( 1, 1, 0, 1 ) = \ell_{4} \cap \ell_{6} $\\
$P_{23} = ( 1, 0, 0, 1 ) = \ell_{4} \cap \ell_{7} $\\
$P_{4} = ( 1, 1, 1, 1 ) = \ell_{6} \cap \ell_{8} $\\
$P_{39} = ( 1, 0, 1, 1 ) = \ell_{7} \cap \ell_{9} $\\
\end{multicols}
...
6 : $P_{30}=( 0, 2, 0, 1 )$ lies on line $\ell_{3}$\\
7 : $P_{31}=( 1, 2, 0, 1 )$ lies on line $\ell_{4}$\\
8 : $P_{34}=( 0, 3, 0, 1 )$ lies on line $\ell_{3}$\\
9 : $P_{35}=( 1, 3, 0, 1 )$ lies on line $\ell_{4}$\\
10 : $P_{38}=( 0, 0, 1, 1 )$ lies on line $\ell_{5}$\\
11 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{5}$\\
12 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{7}$\\
13 : $P_{58}=( 1, 1, 2, 1 )$ lies on line $\ell_{6}$\\
14 : $P_{59}=( 2, 1, 2, 1 )$ lies on line $\ell_{8}$\\
15 : $P_{67}=( 2, 3, 2, 1 )$ lies on line $\ell_{9}$\\
16 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{5}$\\
17 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{7}$\\
18 : $P_{74}=( 1, 1, 3, 1 )$ lies on line $\ell_{6}$\\
19 : $P_{76}=( 3, 1, 3, 1 )$ lies on line $\ell_{8}$\\
20 : $P_{80}=( 3, 2, 3, 1 )$ lies on line $\ell_{9}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{0} & P_{2} & P_{2} & P_{2} & P_{2} & P_{8}\\
\hline
\end{array}
$$
Line 2 intersects 
...
\hline
\mbox{in point}  & P_{5} & P_{2} & P_{2} & P_{2} & P_{2} & P_{12}\\
\hline
\end{array}
$$
Line 3 intersects 
...
\hline
\mbox{in point}  & P_{1} & P_{1} & P_{27} & P_{23}\\
\hline
\end{array}
$$
Line 5 intersects 
...
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{27} & P_{2} & P_{2} & P_{4}\\
\hline
\end{array}
$$
Line 7 intersects 
...
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{23} & P_{2} & P_{2} & P_{39}\\
\hline
\end{array}
$$
Line 8 intersects 
...
\hline
\mbox{in point}  & P_{8} & P_{26} & P_{4} & P_{26}\\
\hline
\end{array}
$$
Line 9 intersects 
...
\hline
\mbox{in point}  & P_{12} & P_{26} & P_{39} & P_{26}\\
\hline
\end{array}
$$
