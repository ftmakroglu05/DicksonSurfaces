...
Rank of lines: ( 340, 356 )\\
Rank of points on Klein quadric: ( 9, 1 )\\
...
2 : $P_{26}=( 0, 1, 0, 1 )$ lies on line $\ell_{0}$\\
3 : $P_{30}=( 0, 2, 0, 1 )$ lies on line $\ell_{0}$\\
4 : $P_{34}=( 0, 3, 0, 1 )$ lies on line $\ell_{0}$\\
5 : $P_{38}=( 0, 0, 1, 1 )$ lies on line $\ell_{1}$\\
6 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{1}$\\
7 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{1}$\\
\end{multicols}
The single points on the surface are:\\
