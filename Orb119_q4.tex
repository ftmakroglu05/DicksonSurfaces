...
Rank of lines: ( 0, 37, 336, 356, 121, 106 )\\
Rank of points on Klein quadric: ( 0, 108, 101, 1, 112, 150 )\\
...
$P_{11} = ( 0, 1, 1, 0 ) = \ell_{2} \cap \ell_{5} $\\
$P_{27} = ( 1, 1, 0, 1 ) = \ell_{4} \cap \ell_{5} $\\
\end{multicols}
...
5 : $P_{12}=( 1, 1, 1, 0 )$ lies on line $\ell_{1}$\\
6 : $P_{15}=( 0, 2, 1, 0 )$ lies on line $\ell_{2}$\\
7 : $P_{17}=( 2, 2, 1, 0 )$ lies on line $\ell_{1}$\\
8 : $P_{19}=( 0, 3, 1, 0 )$ lies on line $\ell_{2}$\\
9 : $P_{22}=( 3, 3, 1, 0 )$ lies on line $\ell_{1}$\\
10 : $P_{38}=( 0, 0, 1, 1 )$ lies on line $\ell_{3}$\\
11 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{5}$\\
12 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{3}$\\
13 : $P_{58}=( 1, 1, 2, 1 )$ lies on line $\ell_{4}$\\
14 : $P_{66}=( 1, 3, 2, 1 )$ lies on line $\ell_{5}$\\
15 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{3}$\\
16 : $P_{74}=( 1, 1, 3, 1 )$ lies on line $\ell_{4}$\\
17 : $P_{78}=( 1, 2, 3, 1 )$ lies on line $\ell_{5}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{1} & P_{2} & P_{2} & P_{2} & P_{11}\\
\hline
\end{array}
$$
Line 3 intersects 
...
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{2} & P_{27}\\
\hline
\end{array}
$$
Line 5 intersects 
