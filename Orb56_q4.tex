...
\begin{align*}
S_{0} &= P_{23}=\bP(1, 0, 0, 1) = \bP(1, 0, 0, 1)\\
\end{align*}
...
Rank of lines: ( 337, 339, 338, 99, 94 )\\
Rank of points on Klein quadric: ( 129, 143, 136, 83, 92 )\\
...
\begin{multicols}{2}
\noindent
$P_{45} = ( 0, 2, 1, 1 ) = \ell_{0} \cap \ell_{3} $\\
$P_{49} = ( 0, 3, 1, 1 ) = \ell_{0} \cap \ell_{4} $\\
...
\begin{multicols}{2}
\noindent
0 : $P_{16}=( 1, 2, 1, 0 )$ lies on line $\ell_{3}$\\
1 : $P_{20}=( 1, 3, 1, 0 )$ lies on line $\ell_{4}$\\
...
6 : $P_{60}=( 3, 1, 2, 1 )$ lies on line $\ell_{4}$\\
7 : $P_{61}=( 0, 2, 2, 1 )$ lies on line $\ell_{1}$\\
8 : $P_{65}=( 0, 3, 2, 1 )$ lies on line $\ell_{1}$\\
9 : $P_{68}=( 3, 3, 2, 1 )$ lies on line $\ell_{3}$\\
10 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{2}$\\
11 : $P_{73}=( 0, 1, 3, 1 )$ lies on line $\ell_{2}$\\
12 : $P_{75}=( 2, 1, 3, 1 )$ lies on line $\ell_{3}$\\
13 : $P_{77}=( 0, 2, 3, 1 )$ lies on line $\ell_{2}$\\
14 : $P_{79}=( 2, 2, 3, 1 )$ lies on line $\ell_{4}$\\
15 : $P_{81}=( 0, 3, 3, 1 )$ lies on line $\ell_{2}$\\
\end{multicols}
The single points on the surface are:\\
