...
Rank of lines: ( 72, 145, 4689, 729 )\\
Rank of points on Klein quadric: ( 81, 201, 25, 209 )\\
...
3 : $P_{19}=( 0, 1, 1, 0 )$ lies on line $\ell_{2}$\\
4 : $P_{20}=( 1, 1, 1, 0 )$ lies on line $\ell_{3}$\\
5 : $P_{75}=( 1, 0, 0, 1 )$ lies on line $\ell_{0}$\\
6 : $P_{76}=( 2, 0, 0, 1 )$ lies on line $\ell_{0}$\\
7 : $P_{77}=( 3, 0, 0, 1 )$ lies on line $\ell_{0}$\\
8 : $P_{78}=( 4, 0, 0, 1 )$ lies on line $\ell_{0}$\\
9 : $P_{79}=( 5, 0, 0, 1 )$ lies on line $\ell_{0}$\\
10 : $P_{80}=( 6, 0, 0, 1 )$ lies on line $\ell_{0}$\\
11 : $P_{81}=( 7, 0, 0, 1 )$ lies on line $\ell_{0}$\\
12 : $P_{83}=( 1, 1, 0, 1 )$ lies on line $\ell_{1}$\\
13 : $P_{92}=( 2, 2, 0, 1 )$ lies on line $\ell_{1}$\\
14 : $P_{101}=( 3, 3, 0, 1 )$ lies on line $\ell_{1}$\\
15 : $P_{110}=( 4, 4, 0, 1 )$ lies on line $\ell_{1}$\\
16 : $P_{119}=( 5, 5, 0, 1 )$ lies on line $\ell_{1}$\\
17 : $P_{128}=( 6, 6, 0, 1 )$ lies on line $\ell_{1}$\\
18 : $P_{137}=( 7, 7, 0, 1 )$ lies on line $\ell_{1}$\\
19 : $P_{146}=( 0, 1, 1, 1 )$ lies on line $\ell_{2}$\\
20 : $P_{217}=( 0, 2, 2, 1 )$ lies on line $\ell_{2}$\\
21 : $P_{219}=( 2, 2, 2, 1 )$ lies on line $\ell_{3}$\\
22 : $P_{289}=( 0, 3, 3, 1 )$ lies on line $\ell_{2}$\\
23 : $P_{292}=( 3, 3, 3, 1 )$ lies on line $\ell_{3}$\\
24 : $P_{361}=( 0, 4, 4, 1 )$ lies on line $\ell_{2}$\\
25 : $P_{365}=( 4, 4, 4, 1 )$ lies on line $\ell_{3}$\\
26 : $P_{433}=( 0, 5, 5, 1 )$ lies on line $\ell_{2}$\\
27 : $P_{438}=( 5, 5, 5, 1 )$ lies on line $\ell_{3}$\\
28 : $P_{505}=( 0, 6, 6, 1 )$ lies on line $\ell_{2}$\\
29 : $P_{511}=( 6, 6, 6, 1 )$ lies on line $\ell_{3}$\\
30 : $P_{577}=( 0, 7, 7, 1 )$ lies on line $\ell_{2}$\\
31 : $P_{584}=( 7, 7, 7, 1 )$ lies on line $\ell_{3}$\\
\end{multicols}
The single points on the surface are:\\
