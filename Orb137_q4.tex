...
Rank of lines: ( 0, 16, 21, 356, 100, 68, 47 )\\
Rank of points on Klein quadric: ( 0, 2, 102, 1, 6, 240, 300 )\\
\subsubsection*{Eckardt Points}
The surface has 1 Eckardt points:\\
$0 : P_{2}=\bP(0, 0, 1, 0) = \bP(0, 0, 1, 0).\; T= 20$\\
...
$P_{9} = ( 2, 0, 1, 0 ) = \ell_{1} \cap \ell_{5} $\\
$P_{10} = ( 3, 0, 1, 0 ) = \ell_{1} \cap \ell_{6} $\\
$P_{42} = ( 0, 1, 1, 1 ) = \ell_{5} \cap \ell_{6} $\\
\end{multicols}
...
\begin{multicols}{2}
\noindent
0 : $P_{3}=( 0, 0, 0, 1 )$ lies on line $\ell_{3}$\\
1 : $P_{5}=( 1, 1, 0, 0 )$ lies on line $\ell_{0}$\\
2 : $P_{6}=( 2, 1, 0, 0 )$ lies on line $\ell_{0}$\\
3 : $P_{7}=( 3, 1, 0, 0 )$ lies on line $\ell_{0}$\\
4 : $P_{12}=( 1, 1, 1, 0 )$ lies on line $\ell_{2}$\\
5 : $P_{16}=( 1, 2, 1, 0 )$ lies on line $\ell_{2}$\\
6 : $P_{20}=( 1, 3, 1, 0 )$ lies on line $\ell_{2}$\\
7 : $P_{23}=( 1, 0, 0, 1 )$ lies on line $\ell_{4}$\\
8 : $P_{28}=( 2, 1, 0, 1 )$ lies on line $\ell_{5}$\\
9 : $P_{29}=( 3, 1, 0, 1 )$ lies on line $\ell_{6}$\\
10 : $P_{38}=( 0, 0, 1, 1 )$ lies on line $\ell_{3}$\\
11 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{4}$\\
12 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{3}$\\
13 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{4}$\\
14 : $P_{58}=( 1, 1, 2, 1 )$ lies on line $\ell_{5}$\\
15 : $P_{59}=( 2, 1, 2, 1 )$ lies on line $\ell_{6}$\\
16 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{3}$\\
17 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{4}$\\
18 : $P_{74}=( 1, 1, 3, 1 )$ lies on line $\ell_{6}$\\
19 : $P_{76}=( 3, 1, 3, 1 )$ lies on line $\ell_{5}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{0} & P_{8} & P_{2} & P_{2} & P_{9} & P_{10}\\
\hline
\end{array}
$$
Line 2 intersects 
