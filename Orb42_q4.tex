...
Rank of lines: ( 345, 106, 355, 129, 350, 149 )\\
Rank of points on Klein quadric: ( 13, 150, 15, 173, 14, 166 )\\
...
\begin{multicols}{2}
\noindent
$P_{11} = ( 0, 1, 1, 0 ) = \ell_{0} \cap \ell_{1} $\\
$P_{78} = ( 1, 2, 3, 1 ) = \ell_{1} \cap \ell_{3} $\\
$P_{66} = ( 1, 3, 2, 1 ) = \ell_{1} \cap \ell_{5} $\\
$P_{15} = ( 0, 2, 1, 0 ) = \ell_{2} \cap \ell_{3} $\\
$P_{4} = ( 1, 1, 1, 1 ) = \ell_{3} \cap \ell_{5} $\\
$P_{19} = ( 0, 3, 1, 0 ) = \ell_{4} \cap \ell_{5} $\\
\end{multicols}
...
\begin{multicols}{2}
\noindent
0 : $P_{27}=( 1, 1, 0, 1 )$ lies on line $\ell_{1}$\\
1 : $P_{31}=( 1, 2, 0, 1 )$ lies on line $\ell_{5}$\\
2 : $P_{35}=( 1, 3, 0, 1 )$ lies on line $\ell_{3}$\\
3 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{1}$\\
4 : $P_{42}=( 0, 1, 1, 1 )$ lies on line $\ell_{0}$\\
5 : $P_{45}=( 0, 2, 1, 1 )$ lies on line $\ell_{2}$\\
6 : $P_{49}=( 0, 3, 1, 1 )$ lies on line $\ell_{4}$\\
7 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{3}$\\
8 : $P_{57}=( 0, 1, 2, 1 )$ lies on line $\ell_{4}$\\
9 : $P_{61}=( 0, 2, 2, 1 )$ lies on line $\ell_{0}$\\
10 : $P_{65}=( 0, 3, 2, 1 )$ lies on line $\ell_{2}$\\
11 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{5}$\\
12 : $P_{73}=( 0, 1, 3, 1 )$ lies on line $\ell_{2}$\\
13 : $P_{77}=( 0, 2, 3, 1 )$ lies on line $\ell_{4}$\\
14 : $P_{81}=( 0, 3, 3, 1 )$ lies on line $\ell_{0}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{11} & P_{78} & P_{66}\\
\hline
\end{array}
$$
Line 2 intersects 
...
\hline
\mbox{in point}  & P_{78} & P_{15} & P_{4}\\
\hline
\end{array}
$$
Line 4 intersects 
...
\hline
\mbox{in point}  & P_{66} & P_{4} & P_{19}\\
\hline
\end{array}
$$
