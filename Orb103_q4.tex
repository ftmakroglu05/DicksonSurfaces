...
Rank of lines: ( 0, 16, 37, 340, 356 )\\
Rank of points on Klein quadric: ( 0, 2, 108, 9, 1 )\\
...
2 : $P_{8}=( 1, 0, 1, 0 )$ lies on line $\ell_{1}$\\
3 : $P_{9}=( 2, 0, 1, 0 )$ lies on line $\ell_{1}$\\
4 : $P_{10}=( 3, 0, 1, 0 )$ lies on line $\ell_{1}$\\
5 : $P_{12}=( 1, 1, 1, 0 )$ lies on line $\ell_{2}$\\
6 : $P_{17}=( 2, 2, 1, 0 )$ lies on line $\ell_{2}$\\
7 : $P_{22}=( 3, 3, 1, 0 )$ lies on line $\ell_{2}$\\
8 : $P_{26}=( 0, 1, 0, 1 )$ lies on line $\ell_{3}$\\
9 : $P_{30}=( 0, 2, 0, 1 )$ lies on line $\ell_{3}$\\
10 : $P_{34}=( 0, 3, 0, 1 )$ lies on line $\ell_{3}$\\
11 : $P_{38}=( 0, 0, 1, 1 )$ lies on line $\ell_{4}$\\
12 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{4}$\\
