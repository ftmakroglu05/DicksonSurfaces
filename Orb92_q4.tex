...
\begin{align*}
S_{0} &= P_{57}=\bP(0, 1, \omega , 1) = \bP(0, 1, 2, 1)\\
S_{1} &= P_{73}=\bP(0, 1, \omega^{2}, 1) = \bP(0, 1, 3, 1)\\
\end{align*}
...
Rank of lines: ( 336, 341, 133, 153 )\\
Rank of points on Klein quadric: ( 101, 105, 346, 296 )\\
...
$P_{73} = ( 0, 1, 3, 1 ) = \ell_{1} \cap \ell_{2} $\\
$P_{57} = ( 0, 1, 2, 1 ) = \ell_{1} \cap \ell_{3} $\\
$P_{12} = ( 1, 1, 1, 0 ) = \ell_{2} \cap \ell_{3} $\\
\end{multicols}
...
1 : $P_{11}=( 0, 1, 1, 0 )$ lies on line $\ell_{0}$\\
2 : $P_{15}=( 0, 2, 1, 0 )$ lies on line $\ell_{0}$\\
3 : $P_{19}=( 0, 3, 1, 0 )$ lies on line $\ell_{0}$\\
4 : $P_{26}=( 0, 1, 0, 1 )$ lies on line $\ell_{1}$\\
5 : $P_{33}=( 3, 2, 0, 1 )$ lies on line $\ell_{2}$\\
6 : $P_{36}=( 2, 3, 0, 1 )$ lies on line $\ell_{3}$\\
7 : $P_{42}=( 0, 1, 1, 1 )$ lies on line $\ell_{1}$\\
8 : $P_{48}=( 3, 2, 1, 1 )$ lies on line $\ell_{3}$\\
9 : $P_{51}=( 2, 3, 1, 1 )$ lies on line $\ell_{2}$\\
10 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{2}$\\
11 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{3}$\\
\end{multicols}
The single points on the surface are:\\
...
\hline
\mbox{in point}  & P_{2} & P_{73} & P_{57}\\
\hline
\end{array}
$$
Line 2 intersects 
