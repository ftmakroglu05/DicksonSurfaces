...
\end{array}
\right]_{94}
={\rm\bf Pl}(1,1,1,3,1,0 )_{92}$$
Rank of lines: ( 337, 356, 100, 289, 205, 99, 94 )\\
Rank of points on Klein quadric: ( 129, 1, 6, 114, 113, 83, 92 )\\
\subsubsection*{Eckardt Points}
The surface has 1 Eckardt points:\\
$0 : P_{23}=\bP(1, 0, 0, 1) = \bP(1, 0, 0, 1).\; T= -1$\\
\subsubsection*{Double Points}
The surface has 5 Double points:\\
The double points on the surface are:\\
\begin{multicols}{2}
\noindent
$P_{38} = ( 0, 0, 1, 1 ) = \ell_{0} \cap \ell_{1} $\\
$P_{45} = ( 0, 2, 1, 1 ) = \ell_{0} \cap \ell_{5} $\\
$P_{49} = ( 0, 3, 1, 1 ) = \ell_{0} \cap \ell_{6} $\\
$P_{79} = ( 2, 2, 3, 1 ) = \ell_{3} \cap \ell_{6} $\\
$P_{68} = ( 3, 3, 2, 1 ) = \ell_{4} \cap \ell_{5} $\\
\end{multicols}
...
4 : $P_{32}=( 2, 2, 0, 1 )$ lies on line $\ell_{3}$\\
5 : $P_{37}=( 3, 3, 0, 1 )$ lies on line $\ell_{4}$\\
6 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{2}$\\
7 : $P_{42}=( 0, 1, 1, 1 )$ lies on line $\ell_{0}$\\
8 : $P_{47}=( 2, 2, 1, 1 )$ lies on line $\ell_{3}$\\
9 : $P_{52}=( 3, 3, 1, 1 )$ lies on line $\ell_{4}$\\
10 : $P_{53}=( 0, 0, 2, 1 )$ lies on line $\ell_{1}$\\
11 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{2}$\\
12 : $P_{60}=( 3, 1, 2, 1 )$ lies on line $\ell_{6}$\\
13 : $P_{63}=( 2, 2, 2, 1 )$ lies on line $\ell_{3}$\\
14 : $P_{69}=( 0, 0, 3, 1 )$ lies on line $\ell_{1}$\\
15 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{2}$\\
16 : $P_{75}=( 2, 1, 3, 1 )$ lies on line $\ell_{5}$\\
17 : $P_{84}=( 3, 3, 3, 1 )$ lies on line $\ell_{4}$\\
\end{multicols}
The single points on the surface are:\\
...
\begin{array}{|r*{3}{|c}|}
\hline
\mbox{Line}  & \ell_{1} & \ell_{5} & \ell_{6}\\
\hline
\mbox{in point}  & P_{38} & P_{45} & P_{49}\\
\hline
\end{array}
$$
Line 1 intersects 
...
\hline
\mbox{in point}  & P_{38} & P_{2} & P_{2} & P_{2}\\
\hline
\end{array}
$$
Line 2 intersects 
...
\begin{array}{|r*{5}{|c}|}
\hline
\mbox{Line}  & \ell_{1} & \ell_{3} & \ell_{4} & \ell_{5} & \ell_{6}\\
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{2} & P_{23} & P_{23}\\
\hline
\end{array}
$$
Line 3 intersects 
...
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{2} & P_{79}\\
\hline
\end{array}
$$
Line 4 intersects 
...
\hline
\mbox{in point}  & P_{2} & P_{2} & P_{2} & P_{68}\\
\hline
\end{array}
$$
Line 5 intersects 
...
\hline
\mbox{in point}  & P_{45} & P_{23} & P_{68} & P_{23}\\
\hline
\end{array}
$$
Line 6 intersects 
...
\hline
\mbox{in point}  & P_{49} & P_{23} & P_{79} & P_{23}\\
\hline
\end{array}
$$
