...
Rank of lines: ( 0, 16, 336, 84, 100 )\\
Rank of points on Klein quadric: ( 0, 2, 101, 10, 6 )\\
...
6 : $P_{11}=( 0, 1, 1, 0 )$ lies on line $\ell_{2}$\\
7 : $P_{15}=( 0, 2, 1, 0 )$ lies on line $\ell_{2}$\\
8 : $P_{19}=( 0, 3, 1, 0 )$ lies on line $\ell_{2}$\\
9 : $P_{27}=( 1, 1, 0, 1 )$ lies on line $\ell_{3}$\\
10 : $P_{31}=( 1, 2, 0, 1 )$ lies on line $\ell_{3}$\\
11 : $P_{35}=( 1, 3, 0, 1 )$ lies on line $\ell_{3}$\\
12 : $P_{39}=( 1, 0, 1, 1 )$ lies on line $\ell_{4}$\\
13 : $P_{54}=( 1, 0, 2, 1 )$ lies on line $\ell_{4}$\\
14 : $P_{70}=( 1, 0, 3, 1 )$ lies on line $\ell_{4}$\\
\end{multicols}
The single points on the surface are:\\
