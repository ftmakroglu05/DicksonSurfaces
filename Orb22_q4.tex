...
Rank of lines: ( 0, 16, 340, 356, 38, 81, 61 )\\
Rank of points on Klein quadric: ( 0, 2, 9, 1, 198, 332, 265 )\\
...
$P_{69} = ( 0, 0, 3, 1 ) = \ell_{3} \cap \ell_{5} $\\
$P_{53} = ( 0, 0, 2, 1 ) = \ell_{3} \cap \ell_{6} $\\
\end{multicols}
...
1 : $P_{8}=( 1, 0, 1, 0 )$ lies on line $\ell_{1}$\\
2 : $P_{9}=( 2, 0, 1, 0 )$ lies on line $\ell_{1}$\\
3 : $P_{10}=( 3, 0, 1, 0 )$ lies on line $\ell_{1}$\\
4 : $P_{26}=( 0, 1, 0, 1 )$ lies on line $\ell_{2}$\\
5 : $P_{30}=( 0, 2, 0, 1 )$ lies on line $\ell_{2}$\\
6 : $P_{34}=( 0, 3, 0, 1 )$ lies on line $\ell_{2}$\\
7 : $P_{47}=( 2, 2, 1, 1 )$ lies on line $\ell_{4}$\\
8 : $P_{52}=( 3, 3, 1, 1 )$ lies on line $\ell_{4}$\\
9 : $P_{60}=( 3, 1, 2, 1 )$ lies on line $\ell_{6}$\\
10 : $P_{62}=( 1, 2, 2, 1 )$ lies on line $\ell_{6}$\\
11 : $P_{67}=( 2, 3, 2, 1 )$ lies on line $\ell_{6}$\\
12 : $P_{75}=( 2, 1, 3, 1 )$ lies on line $\ell_{5}$\\
13 : $P_{80}=( 3, 2, 3, 1 )$ lies on line $\ell_{5}$\\
14 : $P_{82}=( 1, 3, 3, 1 )$ lies on line $\ell_{5}$\\
\end{multicols}
The single points on the surface are:\\
...
\begin{array}{|r*{5}{|c}|}
\hline
\mbox{Line}  & \ell_{1} & \ell_{2} & \ell_{4} & \ell_{5} & \ell_{6}\\
\hline
\mbox{in point}  & P_{0} & P_{1} & P_{5} & P_{6} & P_{7}\\
\hline
\end{array}
$$
Line 1 intersects 
...
\mbox{Line}  & \ell_{1} & \ell_{2} & \ell_{4} & \ell_{5} & \ell_{6}\\
\hline
\mbox{in point}  & P_{2} & P_{3} & P_{38} & P_{69} & P_{53}\\
\hline
\end{array}
$$
Line 4 intersects 
